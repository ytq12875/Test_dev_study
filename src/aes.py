...
if __name__ == '__main__':
    import base64
    text = 'Date12358'
    key = 't6LtKa3tD5X6qaJ6qOrAW3XmIbFrY6ob'
    iv = 'NjtP47eSECuOm3s6'
    aes = AES256Crypto(key, Mode.OFB, Padding.SPACE, iv)
    text_3 = aes.encrypt(text, encode=base64.b64encode)
    text_4 = aes.decrypt(text_3, decode=base64.b64decode)
    print("密文为："  + text_3)
    print("明文为：" + text_4)